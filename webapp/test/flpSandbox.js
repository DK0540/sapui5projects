		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Block layout",
									"targetURL": "#comexampleblocklayout-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexampleblocklayout-display": {
								"semanticObject": "comexampleblocklayout",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.blocklayout",
									"url": sap.ui.require.toUrl("com/example/blocklayout")
								}
							}
						}
					}
